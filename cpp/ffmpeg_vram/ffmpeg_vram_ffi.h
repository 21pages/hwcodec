...
void *ffmpeg_vram_new_decoder(void *device, int64_t luid,
                              int32_t codecID);
void *ffmpeg_vram_new_decoder_ex(void *device, int64_t luid,
                                 int32_t codecID, int32_t bitDepth);
...
int ffmpeg_vram_test_decode_ex(int64_t *outLuids, int32_t *outVendors,
                               int32_t maxDescNum, int32_t *outDescNum,
                               int32_t dataFormat, int32_t bitDepth,
...
void *ffmpeg_vram_new_encoder_ex(void *handle, int64_t luid,
...
int ffmpeg_vram_test_encode(int64_t *outLuids, int32_t *outVendors, int32_t maxDescNum,
                            ...
                            int32_t kbs, int32_t framerate, int32_t gop,
                            const int64_t *excludedLuids, const int32_t *excludeFormats, int32_t excludeCount);
int ffmpeg_vram_test_encode_ex(int64_t *outLuids, int32_t *outVendors,
                               int32_t maxDescNum, int32_t *outDescNum,
                               int32_t dataFormat, int32_t width,
                               int32_t height, int32_t kbs,
                               int32_t framerate, int32_t gop,
